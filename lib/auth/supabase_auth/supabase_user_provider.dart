...
class TradeFriendSupabaseUser extends BaseAuthUser {
  TradeFriendSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> tradeFriendSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = TradeFriendSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
