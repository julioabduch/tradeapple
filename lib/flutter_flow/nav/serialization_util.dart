    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case App10xRow:
            return App10xRow(data);
          case CadastroProdutosTradeRow:
            return CadastroProdutosTradeRow(data);
          case CategoriaTradeRow:
            return CategoriaTradeRow(data);
          case Produtos4Row:
            return Produtos4Row(data);
          case CadastroSuppliersTradeRow:
            return CadastroSuppliersTradeRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case CadastroRow:
            return CadastroRow(data);
          case VersiculosRow:
            return VersiculosRow(data);
          case Cadastro2Row:
            return Cadastro2Row(data);
          default:
            return null;
        }
